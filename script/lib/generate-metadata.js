...
class GenerateMetadata extends Task {
  constructor() {
  ...
  run() {
    ...
    CONFIG.appMetadata._atomPackages = this.buildBundledPackagesMetadata();
    ...
    // THIS WAS DEFINED AFTER THE ABOVE IN A DIFFERENT module.exports = function () {}
    // console.log(
    //   `Generating metadata for ${path.join(
    //     CONFIG.intermediateAppPath,
    //     'package.json'
...
module.exports = new GenerateMetadata();
