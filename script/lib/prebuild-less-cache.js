...
class PrebuildLessCache extends Task {
  constructor() {
    super("Prebuild LESS cache");
  }
  ...
  run() {
    ...
    this.subtask(`Generating pre-built less cache in ${cacheDirPath}`);
...
module.exports = new PrebuildLessCache();
