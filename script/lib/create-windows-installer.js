...
class CreateWindowsInstaller extends Task {
  constructor() {
    super("Create Windows installer");
  }
  ...
  run(packagedAppPath) {
    ...
    this.subtask(`Creating Windows Installer for ${packagedAppPath}`);
...
module.exports = new CreateWindowsInstaller();
