...
class BackupNodeModules extends Task {
  constructor() {
    super("Backup Node modules");
  }

  run(packagePath) {
    this.subtask(`Backing up node modules for ${packagePath}`);
...
module.exports = new BackupNodeModules();
